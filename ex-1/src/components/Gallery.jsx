...
const heroes =  [
        ...
        }, 
        {
            ...
            "universe": "DC",
            "alterego": "Кларк Кент",
            "activity": "борец с преступностью",
...
const Gallery = () => {
    return(
        <React.Fragment>
            ...
            {
                heroes.map((hero) => 
                    <Superhero key={hero.id} name={hero.name} universe={hero.universe} alterego={hero.alterego} activity={hero.activity} friends={hero.friends} superpower={hero.superpower} image={hero.image} more={hero.more} />
                )
            }
            </section>
        </React.Fragment>
